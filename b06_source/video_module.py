...
class VideoInterface:
    ...
    def run_synchronizer(self, synchronizer: Synchronizer, use_gpu: bool, output_directory: Path, overwrite: bool) -> None:
        self.synchronizer_object = synchronizer(video_metadata = self.metadata, use_gpu = use_gpu, output_directory = output_directory)
        self.synchronized_object_filepath, self.already_synchronized = self.synchronizer_object.run_synchronization(overwrite = overwrite)

...
class IntrinsicCameraCalibrator(ABC):
    ...
    def run(self) -> Dict:
        ...
        detected_checkerboard_corners_per_image = self._detect_board_corners(frame_idxs = selected_frame_idxs)
...
class IntrinsicCalibratorRegularCameraCheckerboard(IntrinsicCameraCalibratorCheckerboard):
